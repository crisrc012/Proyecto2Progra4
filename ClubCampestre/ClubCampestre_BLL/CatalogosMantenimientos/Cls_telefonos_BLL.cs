...
namespace ClubCampestre_BLL
{
    public class Cls_Telefonos_BLL
    {
        ...
        #endregion
        public void listarTelefonos(ref Cls_Estado_DAL Obj_Estado_DAL)
        {
            Obj_BD_DAL = new Cls_BD_DAL();
            string _sMsjError = string.Empty;
            Obj_Estado_DAL.DS.Tables.Add(Obj_BD_BLL.ExecuteDataAdapter("[dbo].[sp_select_TB_Telefonos]", string.Empty, SqlDbType.VarChar, string.Empty, ref _sMsjError).Copy());
