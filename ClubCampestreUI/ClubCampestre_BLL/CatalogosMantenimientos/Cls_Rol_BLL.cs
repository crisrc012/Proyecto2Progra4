    ...
    public class Cls_Rol_BLL
    {
        ...
        public void Insertar(ref Cls_Rol_DAL Obj_Rol_DAL)
        {
            ...
            try
            {
                ...
                byte bScalar = Obj_Rol_Client.insertarRol(Obj_Rol_DAL.bIdRol, Obj_Rol_DAL.sDescripcion, ref sMsjError); // Aqui se devuelve un valor scalar, sino se va a usar, hay que mejor mandarlo a usar nonquery
                Obj_Rol_Client.Close();
                Obj_Rol_DAL.sMsjError = sMsjError;
            }
            catch (Exception ex)
